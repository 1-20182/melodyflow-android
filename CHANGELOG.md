...
### Fixed
- 修复「我的」页面点击「已缓存歌曲」时 CachedSongsActivity 因主题 ActionBar 与 Toolbar 冲突导致的闪退（issue #1）

## [2.3.2] - 2026-06-22

### Fixed
- 修复 release 构建中 RecyclerView setHasFixedSize 与 wrap_content 冲突的 lint 错误（彻底固化）

## [2.3.1] - 2026-06-22

### Fixed
- 修复从数据库 v5 升级到 v7 时缺少迁移路径导致的启动崩溃
- 补充 MIGRATION_5_6 与 MIGRATION_5_7，覆盖旧版本数据库直升到当前 v7 结构
